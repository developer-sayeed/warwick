      ...
      if (result.success) {
        ...
        if (session?.user) {
          ...
          if (retrySession?.user) {
            ...
            setError(
              "Login succeeded but session not found. Please try again.",
            );
    ...
    <div className="min-h-screen bg-primary   flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-card border border-border rounded-xl p-6 md:p-8 shadow-2xl">
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex flex-col items-center gap-2">
              <div className="bg-white p-4 rounded-xl">
                <img
                  src="https://image-tc.galaxy.tf/wisvg-4agi4bvb08ovx8iy7wpn44ng8/corporate-logo-purple.svg"
                  alt="Warwick"
          ...
          <p className="text-sm text-muted-foreground text-center capitalize mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 md:h-12 border border-[#2E304C]"
              />
            </div>
