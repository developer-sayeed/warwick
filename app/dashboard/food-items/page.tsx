  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Food Items</h1>
      ...
      >
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, discountStartsAt: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, discountEndsAt: e.target.value })
                    }
                  />
                </div>
              </div>
              <p className="text-xs text-muted-foreground">
                Set a countdown end time. The countdown will appear above the description on
                the product modal.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="ingredients">Ingredients (English, comma-separated) *</Label>
                <Input
                  id="ingredients"
      ...
      <Dialog open={!!deleteId} onOpenChange={(open) => !open && setDeleteId(null)}>
        <DialogContent className="max-w-md">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-end gap-3 pt-4">
            <Button variant="outline" onClick={() => setDeleteId(null)} className="w-full md:w-auto">
              Cancel
            </Button>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="font-semibold text-foreground">{product.price} SAR</span>
      ...
      <div className="hidden md:block bg-card border border-border rounded-lg overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {filteredProducts.map((product) => (
                <tr key={product._id?.toString()} className="border-t border-border">
                  ...
                  <td className="px-6 py-4 text-foreground">{product.price} SAR</td>
                  <td className="px-6 py-4">
                    {product.discount && product.discount > 0 ? (
