...
export function FoodPreviewModal({ item, isOpen, onClose }: FoodPreviewModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-card rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-auto animate-in zoom-in-95 duration-200">
        ...
        <Button
          ...
          size="icon"
          onClick={onClose}
          className="absolute top-4 right-4 z-10 bg-card/80 hover:bg-card rounded-full"
        >
          <X className="h-5 w-5" />
        </Button>
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-5 sm:p-6 md:p-8 flex flex-col">
            <div className="flex-1">
              ...
              <h2 className="font-serif text-2xl sm:text-3xl font-bold text-card-foreground mt-2 mb-3">{item.name}</h2>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-6">
                <div className="bg-secondary rounded-xl p-3 sm:p-4 text-center">
                  ...
                  <span className="block text-base sm:text-lg font-bold text-card-foreground">{item.calories}</span>
                  <span className="text-xs text-muted-foreground">Calories</span>
                </div>
                <div className="bg-secondary rounded-xl p-3 sm:p-4 text-center">
                  <Clock className="h-5 w-5 sm:h-6 sm:w-6 text-primary mx-auto mb-1 sm:mb-2" />
                  <span className="block text-base sm:text-lg font-bold text-card-foreground">{item.prepTime}</span>
                  <span className="text-xs text-muted-foreground">Minutes</span>
                </div>
                <div className="bg-secondary rounded-xl p-3 sm:p-4 text-center">
                  <Utensils className="h-5 w-5 sm:h-6 sm:w-6 text-primary mx-auto mb-1 sm:mb-2" />
                  <span className="block text-base sm:text-lg font-bold text-card-foreground">{item.servings}</span>
              ...
              {item.ingredients && (
                <div className="mb-6">
                  <h4 className="text-sm font-semibold text-card-foreground mb-2">Key Ingredients</h4>
            ...
            <div className="border-t border-border pt-6 mt-auto">
              <div className="flex items-center justify-between">
                <span className="text-2xl sm:text-3xl font-bold text-primary">{item.price} SAR</span>
